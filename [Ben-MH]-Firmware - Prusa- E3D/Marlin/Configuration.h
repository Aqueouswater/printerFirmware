...
#define STRING_VERSION_CONFIG_H "Aug 5th '13 - 3:35PM" //Personal revision number for changes to THIS file.
#define STRING_CONFIG_H_AUTHOR "Ben (Who else?)" //Who made the changes.
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,2560,680}  // default steps per unit for E3d
